...
register_problem!(162, "Hexadecimal numbers", problem162);

pub fn problem162() -> String {
    ...
    let mut result = 0;
    for n in 3..17 {
        result += 15 * u128::power(16, n - 1);
        result += 41 * u128::power(14, n - 1);
        result -= 43 * u128::power(15, n - 1);
        result -= u128::power(13, n);
    }
